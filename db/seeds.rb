...
openehr_terms = Nokogiri::XML(File.open('db/seeds/openehr_terminology_en.xml'))
external_terms = Nokogiri::XML(File.open("db/seeds/external_terminologies_en.xml"))

# seeds of languages code
external_terms.xpath("terminology/codeset[@openehr_id='languages']/code").each do |lang|
  Language.create(code: lang.attr('value'),
